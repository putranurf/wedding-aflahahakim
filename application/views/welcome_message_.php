...
<!-- Library CSS -->
<link href="<?php echo base_url() ?>Template/css/glanz_library.css" rel="stylesheet">

<!-- Icons CSS -->
<link href="<?php echo base_url() ?>Template/fonts/themify-icons.css" rel="stylesheet">

<!-- Theme CSS -->
<link href="<?php echo base_url() ?>Template/css/glanz_style.css" rel="stylesheet">
...
<!-- Other Fonts -->
<link href="<?php echo base_url() ?>Template/fonts/marsha/stylesheet.css" rel="stylesheet">
...
<div class="gla_page" id="gla_page">
        ...
        <nav class="gla_light_nav gla_transp_nav">
            ...
            <div class="container">
                ...
                <div class="gla_logo_container clearfix">
                    <img src="<?php echo base_url() ?>Template/images/glanz_logo.png" alt="" class="gla_logo_rev">
                ...
                <!-- Menu Content -->
                <div class="gla_main_menu_content gla_image_bck" data-color="rgba(0,0,0,0.9)" data-image="<?php echo base_url() ?>Template/images/wedding/lauren_affonso/14400933225_3b844816c3_k.jpg">
                    <!-- Over -->
    ...
    <!-- Slider -->
    <div class="gla_slider gla_image_bck  gla_wht_txt gla_fixed"  data-image="<?php echo base_url() ?>Template/images/wedding/lauren_affonso/14400933225_3b844816c3_k.jpg" data-stellar-background-ratio="0.8">
       ...
       <!-- section -->
        <section class="gla_section gla_image_bck" data-color="#fafafd">
            ...
            <div class="container text-center">
                <p><img src="<?php echo base_url() ?>Template/images/animations/flower5.gif" data-bottom-top="@src:images/animations/flower5.gif; opacity:1" class="gla_animated_flower" height="150" alt=""></p>
                <h2>Our Story</h2>
        ...
        <section class="gla_section gla_image_bck gla_fixed gla_wht_txt" data-stellar-background-ratio="0.8" data-image="http://placehold.it/1400x800">
            ...
            <div class="container text-center">
                <p><img src="<?php echo base_url() ?>Template/images/animations/savethedate_wh.gif" data-bottom-top="@src:images/animations/savethedate_wh.gif" height="150" alt=""></p>
        ...
        <section class="gla_section">
            ...
            <div class="container text-center">
                <p><img src="<?php echo base_url() ?>Template/images/animations/flower6.gif" data-bottom-top="@src:images/animations/flower6.gif; opacity:1" class="gla_animated_flower" height="110" alt=""></p>
        ...
        <section class="gla_section gla_image_bck gla_fixed gla_wht_txt" data-stellar-background-ratio="0.2" data-image="http://placehold.it/1400x800">
            ...
            <div class="container text-center">
                <p><img src="<?php echo base_url() ?>Template/images/animations/rsvp_wh.gif" data-bottom-top="@src:images/animations/rsvp_wh.gif" height="200" alt=""></p>
        ...
        <section class="gla_section gla_image_bck">
            ...
            <div class="container text-center">
                <p><img src="<?php echo base_url() ?>Template/images/animations/flower7.gif" data-bottom-top="@src:images/animations/flower7.gif; opacity:1" class="gla_animated_flower" height="110" alt=""></p>
        ...
        <section class="gla_section gla_image_bck gla_fixed gla_wht_txt" data-stellar-background-ratio="0.8" data-image="http://placehold.it/1400x800">
            ...
            <div class="container text-center">
                <p><img src="<?php echo base_url() ?>Template/images/animations/thnyou_wh.gif" alt="" height="200" data-bottom-top="@src:images/animations/thnyou_wh.gif"></p>
...
<!-- JQuery -->
<script src="<?php echo base_url() ?>Template/js/jquery-1.12.4.min.js"></script> 
<!-- Library JS -->
<script src="<?php echo base_url() ?>Template/js/glanz_library.js"></script> 

<!-- Theme JS -->
<script src="<?php echo base_url() ?>Template/js/glanz_script.js"></script>
